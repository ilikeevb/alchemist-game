export const state = () => ({
    levels: [
        ...
        },
        {
            ...
            good: ["Гелий", "Неон", "Аргон", "Криптон", "Ксенон", "Радон"],
            bad: ["Литий",
                "Железо",
                "Серебро",
                "Золото",
        ...
        },
        {
            ...
            close: true,
            history: ["Надо помочь Алхимику собрать благородные газы.", "Пока это последняя готовая миссия в игре. Поэтому, мы поставили нереальную цель, чтобы вы не смогли открыть следующую миссию"],
            name: 'Благородные газы',
            stars: [{ active: true }, { active: true }, { active: false }],
            theory: [
            ],
        ...
        },
        {
            ...
            close: true,
            history: ["Ты молодец, что добрался до этой точки. Дальше пути пока нет."],
            name: 'Оксиды. Часть 1',
            stars: [{ active: true }, { active: true }, { active: false }],
            theory: [
            ],
